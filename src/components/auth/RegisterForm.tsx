    ...
    <div className="bg-dark-800 p-8 rounded-lg shadow-md max-w-md w-full border border-dark-700">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="university" className="block text-sm font-medium text-dark-200 mb-1">
              University (Optional)
            </label>
            <input
              id="university"
          ...
          <div>
            <label htmlFor="graduationYear" className="block text-sm font-medium text-dark-200 mb-1">
